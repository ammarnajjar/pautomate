...
Pautomate could always use more documentation, whether as part of the
official Pautomate docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.7. Check
   https://travis-ci.org/ammarnajjar/pautomate/pull_requests
